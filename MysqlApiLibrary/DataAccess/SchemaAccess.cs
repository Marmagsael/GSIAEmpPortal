    ...
    private async void _1004_1_InsertMenu10User(string schema="Main"){
        ...
        if(menu.Count == 0)
        {
            sql = @$"insert into {schema}.menus10user
                    ...
                    (110,	110,    100,		0,		    'SHdr', 'SH110',    '',     '',     'My 201 Records',           1,				null,		        null),
                    
                    (111,	111,    110,        1,		    'Dtl',  'D111',     '',     '',     'Personal Information',		0,				'Profiles',			'_111PersonnelInformation'), 
                    (112,	112,    110,        1,		    'Dtl',  'D112',     '',     '',     'Employment',		        0,				'Profiles',			'_112Employment'), 
                    (113,	113,    110,        1,		    'Dtl',  'D113',     '',     '',     'Trainings',		        0,				'Profiles',			'_113Trainings'), 
                    (114,	114,    110,        1,		    'Dtl',  'D114',     '',     '',     'Uploadables',		        0,				'Profiles',			'_114Uploadables'), 
                    (115,	115,    110,        1,		    'Dtl',  'D115',     '',     '',     'Correction Request',		0,				'Profiles',			'_115CorrectionRequest') 
                    "; 
            await _sql.ExecuteCmd(sql, new { });
        }
    }
